...
async def test_simple_claim_backup(block_processor):
    ...
    await block_processor.run_in_thread_with_lock(block_processor.advance_blocks, empty_blocks)
    ...
    await block_processor.run_in_thread_with_lock(block_processor.flush, True)
